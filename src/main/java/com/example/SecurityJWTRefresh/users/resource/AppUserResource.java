package com.example.SecurityJWTRefresh.users.resource;
...
public class AppUserResource {
    ...
    public ResponseEntity<AppUser> saveUser(@RequestBody AppUser appUser){
        // append successful creation message ot the header
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(authorizationHeader != null && authorizationHeader.startsWith("Bearer ")){
            try{
                ...
                Algorithm algorithm = Algorithm.HMAC256("secretsecretsecretsecret".getBytes());
...
// create a new class which includes a String(username) and a String(roleName)
@Data
